...
- `--arch <arch>`: Architectures to build (`x86_64`, `arm64`). Required when neither declared Kraftfile targets nor a runtime give an architecture, such as for Dockerfile-only builds.
